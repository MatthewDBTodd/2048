...
void printText() {
    ...
    mvprintw(7, 6, "100 gets the 2048 tile ~83% of the time and the 4096 tile ~7% of the time");
    mvprintw(9, 6, "500 gets the 2048 tile ~96% of the time and the 4096 tile ~45% of the time");
    mvprintw(11, 6, "1000 gets the 2048 tile ~97% of the time and the 4096 tile ~51% of the time");
    mvprintw(13, 6, "AI strength above 1000 offers quickly diminishing returns, though there are small improvements");
    move(3, 51);
}